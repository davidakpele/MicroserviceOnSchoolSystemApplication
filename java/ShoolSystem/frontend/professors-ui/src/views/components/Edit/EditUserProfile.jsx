...
const EditUserProfile = () => {
    ...
    const fetchUserDetails = async () => {
        const userResponse  = await ApiServices.getProfessorById(id);
    ...
    const FireEditData = async ({data}) => {
        let errors = {};
        const result = await ApiServices.saveEditProfessorDetailsById({ data })
    ...
    const saveNewPassword =async(changePassword) => {
        let errors = {};
        const result = await ApiServices.savePorfessorPasswordChanges({ changePassword })
        if (result.response != null && result.response.status != 200) {
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="row">
                                    <div className="col-md-6 ">
                                        <div className="card">
                                            <div className="card-header">Professor Profile User Details</div>
                                            <div className="card-body">
                                                <form  method="put" acceptCharset="utf-8" onSubmit={saveUpdateUserDetails} autoComplete='off'>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" id="username" className="form-control" defaultValue={userInfo.accessCode} readOnly disabled/>
                                                    </div>
                                                    <div className="row">
                                                        <div className="form-group col-sm-6 col-sm-6">
                                                            ...
                                                            <input type="text" id="firstname" name="firstname" className={`form-control ${formErrors.firstname ? 'is-invalid' : ''}`} defaultValue={userInfo.records[0].firstname} onChange={handleRecordInputChange} readOnly disabled/>
                                                        ...
                                                        <div className="form-group col-sm-6 col-sm-6">
                                                            ...
                                                            <input type="text" id="surname" name="surname" className={`form-control ${formErrors.surname ? 'is-invalid' : ''}`} defaultValue={userInfo.records[0].surname} onChange={handleRecordInputChange} readOnly disabled/>
                                                        ...
                                                        <div className="form-group col-sm-6 col-sm-6">
                                                            ...
                                                            <input type="text" name="mobile" id="mobile" className={`form-control ${formErrors.mobile ? 'is-invalid' : ''}`} defaultValue={userInfo.records[0].mobile} onChange={handleRecordInputChange} readOnly disabled/>
                                                        ...
                                                        <div className="form-group col-sm-6 col-sm-6">
                                                            <Form.Label htmlFor="gender" style={{display: 'inline-block', maxWidth: '100%', marginBottom: '5px',fontWeight: '400'}}>Gender</Form.Label>
                                                             <Form.Select aria-label="gender" id="gender" name="gender"  className={`form-control ${formErrors.gender ? 'is-invalid' : ''}`} defaultValue={userInfo.records[0].gender} onChange={handleRecordInputChange} readOnly disabled>
                                                        ...
                                                        <div className="form-group col-sm-6 col-sm-12">
                                                            ...
                                                            <input type="date" name="dateOfBirth" id='dateOfBirth'  className={`form-control ${formErrors.dateOfBirth ? 'is-invalid' : ''}`} defaultValue={userInfo.records[0].dateOfBirth} onChange={handleRecordInputChange} readOnly disabled/>
                                                        ...
                                                        <div className="form-group col-sm-6 col-sm-6">
                                                            <Form.Label htmlFor="role" style={{display: 'inline-block', maxWidth: '100%', marginBottom: '5px',fontWeight: '400'}}>Role</Form.Label>
                                                             <Form.Select  aria-label="role" id="role"  name="role"  className={`form-control ${formErrors.role ? 'is-invalid' : ''}`} defaultValue={userInfo.role}  onChange={handleInputChange} readOnly disabled>
                                                                <option value="">--Select--</option>
                                                                {roleList.map(role => (
